    ...
    if (state.sendCount) {
      ...
      async function fetchPost() {
        try {
          ...
          appDispatch({ type: "flashMessage", value: "Post was succefully updated." })
        } catch (e) {
          console.log("There was a problem or request has been canceled")
        }
      }
    ...
    <Page title="Edit Post">
      ...
      <form onSubmit={submitHandler} className="mt-3">
        ...
        <div className="form-group">
          ...
          <textarea onBlur={e => dispatch({ type: "bodyRules", value: e.target.value })} value={state.body.value} onChange={e => dispatch({ type: "bodyChange", value: e.target.value })} name="body" id="post-body" className="body-content tall-textarea form-control" type="text" />
